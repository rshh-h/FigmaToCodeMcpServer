/* Copied plugin global typings shim. Keep this file local so codegen-kernel can
 * continue to compile against PluginAPI-compatible shapes after syncing from
 * ../FigmaToCode.
 */
