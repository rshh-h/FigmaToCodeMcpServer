...
const processNodePair = async (
  ...
  const runtimeNode = figmaNode as SceneNode & {
  ...
  if (runtimeNode.localImagePath) {
    (jsonNode as any).localImagePath = runtimeNode.localImagePath;
  }
  if (runtimeNode.localVectorPath) {
    (jsonNode as any).localVectorPath = runtimeNode.localVectorPath;
  }
  if (runtimeNode.isLocalVectorChild) {
    (jsonNode as any).isLocalVectorChild = true;
  }
  if (runtimeNode.localVectorRootId) {
    (jsonNode as any).localVectorRootId = runtimeNode.localVectorRootId;
  }
