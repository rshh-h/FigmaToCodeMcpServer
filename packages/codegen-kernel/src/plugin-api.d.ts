/* plugin-typings are auto-generated. Do not update them directly. Keep this
 * copied snapshot aligned with the upstream plugin typings used by
 * ../FigmaToCode when refreshing the migrated runtime.
 */
/**
